...
- **Color Pallete (Extra):** Choice of multiple colors
- **Toggle Dark Mode (Extra):** Switch b/w modes according to preferences
- **Help (Extra):** Gives instructions to use the app
- **Download/Save (Extra):** Downloads the canvas drawing as a high-quality image (PNG)
